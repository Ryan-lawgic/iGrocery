...
<body>
	...
	<h2><a href="../index.php">HomePage</a></h2>
		...
		<img src="logo.png" id="Pic" width="148px" height="148px"
			...
			<div id="login">
			<form method="post" action="logincheck.php" onsubmit="return checkdata();">
			<p>
			User name:
			<input type="text" id="username" value="" name="username" required="required" onfocus="Change(this.id,'grey');" onblur="Change(this.id,'white');">
			</p>
			<p>
			Password:
			<input type="password" id="password" value=""name="password" required="required" onfocus="Change(this.id,'grey');" onblur="Change(this.id,'white');">
			</p>
			</div>
				<div id="loginbutton">
